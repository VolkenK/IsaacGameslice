...
public class PlayerShoot : MonoBehaviour
{
	...
	void Fire(int rot)
	{
		if (Shoot == true)
		{
			...
			var bullet = (GameObject)Instantiate(bulletPrefab,new Vector3(bulletSpawn.position.x,bulletSpawn.position.y - 0.18f,bulletSpawn.position.z),Quaternion.Euler (0,0,rot*90));
